            ...
            <Animated.Image entering={FadeInUp.delay(200).duration(600).springify().damping(3)} className="h-[165] w-[65] " source={require('../assets/images/light.png')} />
             ...
             <View className='h-full w-full flex justify-around pt-48 pb-10'>
                ...
                <View className='flex items-center mx-4 space-y-4 '>
                    ...
                    <Animated.View entering={FadeInDown.duration(800).springify().delay(400)} className='bg-black/5 p-5 rounded-2xl w-full '>
                        <TextInput className='text-white' placeholder="Username" placeholderTextColor={'gray'}/>
                    </Animated.View>
                    <Animated.View entering={FadeInDown.duration(800).springify().delay(600)} className='bg-black/5 p-5 rounded-2xl w-full mb-7'>
                        <TextInput className='text-white' placeholder="Password" placeholderTextColor={'gray'} secureTextEntry/>
                    </Animated.View>
                    <Animated.View entering={FadeInDown.duration(800).springify().delay(800)} className='w-full'>
                    ...
                    <Animated.View entering={FadeInDown.duration(800).springify().delay(1000)} className='flex-row justify-center'>
                        <Text className='text-cyan-200'>Already have an account? </Text>
